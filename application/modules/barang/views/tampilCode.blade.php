    ...
    <div class="container-fluid">
      ...
      <div class="card-body">
        ...
        <div class="col-xs-3">
          ...
          <div class="card" id="qrcode" style="width: 20rem;">        
              ...
              <div class="row">
                ...
                <div class="col-4">
                  <div class="printqrcode">
                    <img src="{{base_url('assets/dist/img/qrcode/').$kode.'.png'}}" width="55px" height="55px"  alt="Qrcode"></img></br>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-5">
                  <div class="printbarcode">
                    <span>{{$kode}}</span><br>
                    <img src="{{base_url('assets/dist/img/barcode/').$kode.'.jpg'}}" width="120px" height="50px" alt="Barcode"></img></br>
                  </div>
                </div>
                <?php $index1=1;$index2=0;?>
                <div class="col-x5">
